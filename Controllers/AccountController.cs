...
namespace LastLab.Controllers
{
    ...
    public class AccountController : Controller
    {
                ...
                case SignInStatus.Success:
                    {
                        ...
                        var user = db.Users.Where(a => a.UserName == model.UserName).FirstOrDefault();
                        return RedirectToDashboard(returnUrl, user.Id);
                    }
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            {
                case SignInStatus.Success:
                    return RedirectToDashboard(model.ReturnUrl, "");
                case SignInStatus.LockedOut:
                    return View("Lockout");
                case SignInStatus.Failure:
                default:
        ...
        {
            ViewBag.action = "RegisterInstructor";
        ...
        private ActionResult RedirectToDashboard(string returnUrl, string userId)
        {
            ...
            if (UserManager.IsInRole(userId, "Admin"))
                return RedirectToAction("Index", "Admin_ManageStudent");
